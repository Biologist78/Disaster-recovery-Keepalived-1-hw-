# Домашнее задание к занятию "Кластеризация и балансировка нагрузки" - Сенотов А.С.
...
listen stats # statictic web-page
        bind            :888
        mode            http
        stats           enable
        stats uri       /stats
...
frontend example # section frontend
        mode    http
        bind    :8088
        default_backend web_servers

backend web_servers # section backend
        mode            http
        balance         roundrobin
        option          httpchk
...
![Название скриншота 2](img/2.1.png)
##### Запрос на localhost
![Название скриншота 2](img/2.2.png)
##### Статистика api Haproxy
![Название скриншота 2](img/2.3.png)
